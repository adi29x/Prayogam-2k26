  ...
  return (
    <div className="min-h-screen py-12 px-4 md:px-0">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 border-b border-border">
                ...
                <th className="px-8 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Reach</th>
                <th className="px-8 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 text-right">Engagement Score</th>
              </tr>
            </thead>
            <tbody>
              {data.length > 0 ? (
                data.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-8 py-6 text-sm font-black text-gray-400 uppercase tracking-[0.15em]">{item.reach}</td>
                    <td className="px-8 py-6 text-right font-black text-primary tracking-tight text-lg">{item.engagement.toLocaleString()}</td>
                  </tr>
                ))
              ) : (
                <tr>
      ...
      <div className="max-w-5xl mx-auto mt-12 text-center">
        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-[0.3em]">Engagement score measures interactions per post across official channels.</p>
      </div>
    </div>
  );
};
